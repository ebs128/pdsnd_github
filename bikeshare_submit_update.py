...
def get_filters():
    ...
    while True:
        day = input("Which day of the week would you like to filter by? You can choose a specific day or 'All' for the whole week\n")
        day = day.lower()
...
def station_stats(df):
    ...
    print("The most frequent trip combination of start and end station is: ", df['freq_combination'].mode()[0])
...
def user_stats(df, city):
    ...
    # TO DO: Display earliest, most recent, and most common year of birth
        ...
        print("The earier birth year is: ", earliest_yob, "\n")

        most_recent_yob = sorted(df.groupby(['Birth Year'])['Birth Year'], reverse=True)[0][0]
        print("The most recent birth year is: ", most_recent_yob, "\n")

        most_common_yob = df['Birth Year'].mode()[0]
        print("The most common birth year is: ", most_common_yob, "\n")
